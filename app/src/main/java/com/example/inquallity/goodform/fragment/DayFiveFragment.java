...
public class DayFiveFragment extends Fragment {
    ...
    private ExercisePage chooseResource(int count) {
        ...
        switch (count) {
            case 1:
                resTitle = R.string.title_5_1;
                resDescription = R.string.description_5_1;
                resImage = R.drawable.planka_5_1;
                break;
            case 2:
                resTitle = R.string.title_5_2;
                resDescription = R.string.description_5_2;
                resImage = R.drawable.naklony_s_bodybarom_5_2;
                break;
            case 3:
                resTitle = R.string.title_5_3;
                resDescription = R.string.description_5_3;
                resImage = R.drawable.mahi_gantelyami_v_storony_5_3;
                break;
            case 4:
                resTitle = R.string.title_5_4;
                resDescription = R.string.description_5_4;
                resImage = R.drawable.vypady_s_gantelyami_1_5;
                break;
            case 5:
                resTitle = R.string.title_5_5;
                resDescription = R.string.description_5_5;
                resImage = R.drawable.tyaga_ganteli_v_naklone_2_4;
                break;
            case 6:
                resTitle = R.string.title_5_6;
                resDescription = R.string.description_5_6;
                resImage = R.drawable.jim_yzkim_hvatom_5_6;
                break;
            default:
                resTitle = R.string.title_5_1;
                resDescription = R.string.description_5_1;
