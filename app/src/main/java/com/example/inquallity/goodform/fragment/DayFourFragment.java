...
public class DayFourFragment extends Fragment {
    ...
    private ExercisePage chooseResource(int count) {
        ...
        switch (count) {
            case 1:
                resTitle = R.string.title_4_1;
                resDescription = R.string.description_4_1;
                resImage = R.drawable.skruchivanie_uprazhnenie1_1;
                break;
            case 2:
                resTitle = R.string.title_4_2;
                resDescription = R.string.description_4_2;
                resImage = R.drawable.stanovaya_tyaga_na_pryamyh_nogah_s_gantelyami_4_2;
                break;
            case 3:
                resTitle = R.string.title_4_3;
                resDescription = R.string.description_4_3;
                resImage = R.drawable.pulover_2_4;
                break;
            case 4:
                resTitle = R.string.title_4_4;
                resDescription = R.string.description_4_4;
                resImage = R.drawable.razvodka_ganteley_lega_2_3;
                break;
            case 5:
                resTitle = R.string.title_4_5;
                resDescription = R.string.description_4_5;
                resImage = R.drawable.prisedania_4_6;
                break;
            case 6:
                resTitle = R.string.title_4_6;
                resDescription = R.string.description_4_6;
                resImage = R.drawable.otzhimaniya_na_kolenyax_4_7;
                break;
            default:
                resTitle = R.string.title_4_1;
                resDescription = R.string.description_4_1;
